...
//SpringBootTest가 Transactional이 끝나면 자동으로 롤백시킴
@SpringBootTest
@Transactional
...
class MemberJpaRepositoryTest {
    ...
    public void testMember(){
        ...
        // == 비교와 같음: JPA에서는 같은 트랜잭션에서 영속성 컨텍스트 동일성 보장. 1차 캐시
    ...
    public void paging(){
        ...
        // when
        List<Member> members = memberJpaRepository.findByPage(age,offset,limit); // 실제 페이지된 컨텐츠
        long totalCount = memberJpaRepository.totalCount(age); // 페이지 위치
